 ...
 * Mexicanos), terminal San Miguel de Allende, del 14/09/2026 -- Picachos
 * y Ventanas, capturadas manualmente por el usuario desde el reporte de
 * programación que Abastos maneja fuera de la app.
 *
 * AEMSA sí captura hora real (a diferencia de MCG) y nunca transportista
 * (ver PROVEEDORES_SIN_TRANSPORTISTA en scheduling.js).
 *
 * Uso: php tools/import_scheduling_2026-09-14_aemsa_sma.php [--commit]
 */
...
// Filas pegadas por el usuario: litros, producto, estacion (texto libre), hora
$rawRows = [
    [23500, 'Regular', 'picachos', '2:00 p. m.'],
    [23500, 'Regular', 'ventanas', '2:00 p. m.'],
    [20000, 'Premium', 'picachos', '6:00 p. m.'],
];
...
foreach ($rawRows as $i => $row) {
    [$litros, $productoRaw, $estacionRaw, $horaRaw] = $row;
    $lineNo = $i + 1;
