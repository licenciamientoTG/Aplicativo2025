<?php
/**
 * Import de una sola vez: recepciones de MGC México (Gaso Mex) del
 * 15/09/2026, capturadas manualmente por el usuario desde el reporte de
 * programación que Abastos maneja fuera de la app.
 *
 * Mismo formato de MCG: turno (T1/T2/T3) en vez de hora real, EMBARQUE
 * va a "referencia".
 *
 * Uso: php tools/import_scheduling_2026-09-15_mcg_gasomex.php [--commit]
 */
...
$rawRows = [
    [20000, 'Regular', 'fuentes',  'T2', '4565480'],
    [10000, 'Regular', 'satelite', 'T2', '4565484'],
    [10000, 'Premium', 'satelite', 'T2', '4565487'],
    [10000, 'Regular', 'ejercito', 'T2', '4565491'],
    [10000, 'Premium', 'ejercito', 'T2', '4565496'],
    [20000, 'Diesel',  'fuentes',  'T3', '4565502'],
];
