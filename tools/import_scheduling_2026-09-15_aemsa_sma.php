 ...
 * Mexicanos), terminal San Miguel de Allende, del 15/09/2026 -- Picachos
 * y Ventanas.
 *
 * Uso: php tools/import_scheduling_2026-09-15_aemsa_sma.php [--commit]
 */
...
// litros, producto, estacion (texto libre), hora
$rawRows = [
    [23500, 'Regular', 'picachos', '2:00 p. m.'],
    [23500, 'Regular', 'ventanas', '2:00 p. m.'],
    [20000, 'Premium', 'ventanas', '6:00 p. m.'],
];
