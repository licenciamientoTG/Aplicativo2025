<?php
/**
 * Import de una sola vez: recepción de Tesoro México Supply and Marketing
 * (Petrotal) del 09/09/2026, capturada manualmente por el usuario.
 *
 * Uso: php tools/import_scheduling_2026-09-09_tesoro_petrotal.php [--commit]
 */
...
$rawRows = [
    ['09/09/2026', 31000, 'Regular', '5170 plutarco', '12:00 p. m.', ''],
];
