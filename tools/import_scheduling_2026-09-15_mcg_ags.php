<?php
/**
 * Import de una sola vez: recepciones de MGC México (Aguascalientes) del
 ...
 * va a "referencia".
 *
 * Uso: php tools/import_scheduling_2026-09-15_mcg_ags.php [--commit]
 */
...
$rawRows = [
    [20000, 'Regular', 'jesus maria', 'T2', '4550046'],
    [20000, 'Premium', 'san rafael',  'T3', '4550044'],
    [20000, 'Regular', 'san rafael',  'T3', '4550043'],
];

$estacionAliases = [
    'jesus maria' => 'jesus mar',
