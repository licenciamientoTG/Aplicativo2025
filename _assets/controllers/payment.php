...
class Payment
{
    ...
    /**
     * El catálogo de cuentas bancarias se movió a Tesorería (permiso 79,
     * 2026-07-23). Redirect para URLs guardadas; los endpoints AJAX viven
     * ahora en tesoreria.php (bank_accounts_table / update_bank_account /
     * toggle_bank_account).
     */
    public function bank_accounts()
    {
        header('Location: /tesoreria/bank_accounts');
    }
